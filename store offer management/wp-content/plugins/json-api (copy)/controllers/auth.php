...
global $json_api,$wpdb;
  ...
  public function register(){
    ...
    $message         = '';
     ...
     {
          return array('status'=>'error','message'=>"Signup type field is empty.");
     }else
     {   

         if($signup_type=="facebook" || $signup_type=="google")
        {
            if(empty($social_id))
            {
               return array('status'=>'error','message'=>"Social id is empty");
                    ...
                    if ( stristr( $username, " " ) === false ) {
                        if ( ! username_exists( $username ) ) {
                          if ( ! email_exists( $email ) ) {
                           ...
                           return array("message"=>"Social registeration successfull","data"=>$user);
