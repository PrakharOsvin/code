...
<?php
 // echo"<pre>";print_r($in_row);echo"</pre>";die; 
 ?>
          <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
            <thead>
              <tr>
                ...
                <!-- <th>Profile Pic</th>  -->                   
                <th style="width:10%">Trip Created on</th>
        ...
        <td>
                  <a href="<?php echo base_url('Dashboard/trip_info').'/'.$r['job_id']; ?>" style="border-radius:4px !important;" name="Details" class='btn btn-primary'>Details</a>
                  <a href="<?php echo base_url('Dashboard/driver_refuses') ?>" class="btn btn-success">Back</a>
                </td>
              </tr>
              <?php  
              $sid++;} }?>            
