...
<!-- page start-->
    <section class="panel">
      <header class="panel-heading">Driver cancelled Trips</header>
      <div class="panel-body">      
            ...
            <tbody>
             ...
             foreach ($cancelled_trips as $trip) {
              ...
              <tr>
                ...
                <td><?php echo $trip->driver; echo $trip->first_name; ?></td>
        ...
        <td>
                  <a href="<?php echo base_url('Dashboard/driver_cancelled_trips_detail').'/'.$trip->driver_id; ?>" style="border-radius:4px !important;" name="details" class='btn btn-primary'>Details</a>
                </td>
              </tr>
              <?php  
              $sid++; }?>            
