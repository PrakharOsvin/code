...
<div class="loginbg">
    <div class="container">
      <h1 class="text-center mT100 white">Edit Promo Information Here</h1>
    ...
    <label class="control-label">Edit Promo Code</label>
    <div class="controls">
        <input id="field1"  class="form-control" name="promo_code" type="text" value="<?php echo $edit_data->promo_code; ?>" placeholder="promo code"
    ...
    <div class="control-group">
        ...
        <div class="datepicker">
            <input id="field2"  class="form-control avg" name="start_date" type="text" value="<?php echo $edit_data->start_date; ?>" placeholder="Start Date" class="input-xlarge" required>
...
<div class="control-group">
        ...
        <div class="datepicker">
            <input id="field3"  class="form-control avg1" name="end_date" type="text" value="<?php echo $edit_data->end_date ; ?>" placeholder="End Date"
            class="input-xlarge" >
...
<input type="radio" id="example_11"  checked ="checked" name="msg" value="1">
        ...
        <div class="controls">
            <input id="field4" readonly class="form-control" name="dis_amt" onkeypress="return isNumber(event)" type="text" value="<?php echo $edit_data->disc_amt; ?>" placeholder="Discount Amount"
            class="input-xlarge" required>
...
<input type="radio" id ="example_12" name="msg" value="2">
        ...
        <div class="controls">
            <input id="field5" readonly  class="form-control" name="dis_percent" onkeypress="return isNumber(event)" type="text" value="<?php echo $edit_data->disc_percent; ?>"  maxlength="5" onkeyup="this.value = fnc(this.value, 0, 100)" placeholder="Discount Percentage"
            class="input-xlarge" required>
...
<div class="control-group">
        ...
        <div class="controls">
            <input id="field6" readonly class="form-control" name="code_usage" onkeypress="return isNumber(event)" type="text" value="" placeholder="Code Usage" class="input-xlarge" required>
...
$(function(){
    $("#example_11,#example_12").change(function(){
