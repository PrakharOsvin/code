        ...
        <div class="adv-table table-responsive">
          ...
          <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
            ...
            <tbody>
             ...
             <?php  
             $sid = 1;            
             foreach ($low_overall_rating as $trip) {
              ...
              <td><?php echo $trip->rating; ?></td>
				<td>
                  <a href="<?php echo base_url('Users/info').'/'.$trip->id; ?>" style="border-radius:4px !important;" name="view" class='btn btn-primary'>View</a>
                </td>
              </tr>
              <?php  
              $sid++; }?>            
