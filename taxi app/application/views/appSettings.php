...
foreach ($appSettings as $value) { ?>
                              <tr>
                                  ...
                                  <td>
                                    <input id="id-<?php echo "$value->id";?>" btnId="<?php echo "$value->id";?>" class="target" type="number" step="any" value="<?php echo "$value->value";?>"/>
                                  </td>

                                  <td>
                                    <button class="btn btn-success btn-xs" id="<?php echo "$value->id";?>" onclick="appSettings(this)" disabled>Save</button>
                                  </td>
...
// console.log(id+value);return false;
 $.ajax(
             {
                 type: 'post',
                 url: '<?php echo base_url();?>Dashboard/appSettings',
