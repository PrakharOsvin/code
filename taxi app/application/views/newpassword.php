  ...
  <div class="loginbg">
    <div class="container">
      <div class="form-signin">
            <div class="text-center logo2"><img src="<?php echo base_url(); ?>public/images/logo.png" width="160px" class="mR30"/></div>
        <?php 
          // print_r(count($db_result));die;
...
<?php endif; ?>  
        ...
        <?php } else { ?>
                <span style="color:red">This LInk IS Expired</span>
        <?php }
        ?>
      </div>
    </div>
