    ...
    <section class="panel">
      ...
      <div class="panel-body">    	
        <div class="adv-table table-responsive">
          ...
          <?php  echo form_open("Dashboard/addSubtractFund/$userType"); ?> 
             ...
             foreach ($driver_list as $driver) {
              ...
              <td><?php if ($driver->profile_pic){?><img src="<?php echo $driver->profile_pic; ?>" width='100'/><?php } else{ ?><img src="<?php echo base_url('public/images/mythumb.gif'); ?>" /><?php } ?></td>
                ...
                <td>
                  ...
                  <a href="<?php echo base_url('Dashboard/addSubtractFundEdit').'/'.$driver->id; ?>" style="border-radius:4px !important;" name="addSubtractFundEdit" class='btn btn-success'>Add Subtract Funds</a>                                    
