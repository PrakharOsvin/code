...
<section id="main-content">
  <section class="wrapper site-min-height">
    ...
    <!-- page start-->
    <section class="panel">
      <header class="panel-heading">Client cancelled trip details</header>
             ...
             foreach ($cancelled_trips_detail as $trip) {
              ...
              <td><?php if ($trip->profile_pic){?><img src="<?php echo $trip->profile_pic; ?>" width='100'/><?php } else{ ?><img src="<?php echo base_url('public/images/mythumb.gif'); ?>" /><?php } ?></td>
				...
				<td>
                  ...
                  <a href="<?php echo base_url('Dashboard/user_cancelled_trips') ?>" class="btn btn-success">Back to Cancelled Trips</a>
