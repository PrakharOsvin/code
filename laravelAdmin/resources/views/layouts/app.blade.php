...
<head>
    ...
    <nav class="navbar navbar-default navbar-static-top">
        <div class="">
            <center> <img style="height:200px;width:400px"  src="{{ url('/images/logo.png') }}"/></center>
        </div>
    </nav>
  ...
  <!--header start-->
      <header class="header white-bg">
            ...
            <!--logo start-->
            <a href="{{ url('/') }}" class="logo" style="margin-top: 7px; font-family:Arial, Helvetica, sans-serif">Travelflix<!-- <img src="img/logo@3x.png" width="160px;" /> --></a>
            <!--logo end-->
